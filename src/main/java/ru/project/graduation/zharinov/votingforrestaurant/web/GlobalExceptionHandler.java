package ru.project.graduation.zharinov.votingforrestaurant.web;
...
import ru.project.graduation.zharinov.votingforrestaurant.error.AppException;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<?> appException(AppException ex, WebRequest request) {
        ...
        return createProblemDetailExceptionResponse(ex, ex.getType().status, request);
    }
